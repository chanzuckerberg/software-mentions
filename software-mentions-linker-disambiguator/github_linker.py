...
if __name__ == '__main__':
  ...
  parser.add_argument("--IDs-so-far", help="Filter out IDs seen so far", type = str, default = 'github_IDs_queried_total.npy', required = False)
  args = parser.parse_args()
  print(args)

  github_linker = DatabaseLinker(args.input_file, args.output_file, args.min_freq, args.top_k, 
                      args.raw_filename, args.generate_new, 'github_df', args.ID_start, args.ID_end, args.IDs_so_far)
