...
if __name__ == '__main__':
  ...
  parser.add_argument("--input-file", type=str, help="Location of software mentions input file", default = ROOT_DIR + 'comm_IDs.tsv', required = False)
  parser.add_argument('--output-file', type=str, help="Location of frequency dict output file", default = ROOT_DIR + 'freq_dict.pkl')
  ...
  mentions_df = pd.read_csv(args.input_file, sep='\t')
